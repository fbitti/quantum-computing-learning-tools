    ...
    <div className="h-full overflow-y-auto bg-[#0B1020]">
      <div className="max-w-2xl mx-auto px-4 py-10">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h1 className="text-xl font-heading font-bold tracking-tight text-[#F8FAFC]" data-testid="text-policies-title">Policies</h1>
        </div>

        <section className="mb-8" data-testid="section-privacy">
          <h2 className="text-base font-heading font-semibold mb-3 text-[#F8FAFC]">Privacy Policy</h2>
          <div className="text-sm text-[#94A3B8] space-y-2 leading-relaxed font-sans">
            ...
            <p>
                            ...
                            <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-[#22D3EE] underline underline-offset-2">
        ...
        <section className="mb-8" data-testid="section-terms">
          <h2 className="text-base font-heading font-semibold mb-3 text-[#F8FAFC]">Terms of Service</h2>
          <div className="text-sm text-[#94A3B8] space-y-2 leading-relaxed font-sans">
        ...
        <section className="mb-8" data-testid="section-cookies">
          <h2 className="text-base font-heading font-semibold mb-3 text-[#F8FAFC]">Cookie Policy</h2>
          <div className="text-sm text-[#94A3B8] space-y-2 leading-relaxed font-sans">
            <p>
