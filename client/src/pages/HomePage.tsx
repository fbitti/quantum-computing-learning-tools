      ...
      <footer className="border-t border-border py-8 px-4">
        <div className="max-w-4xl mx-auto flex flex-col items-center gap-6 text-xs text-muted-foreground">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://www.youtube.com/@OneMillionQubits" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors" aria-label="YouTube">
          ...
          <p className="text-[10px] text-muted-foreground/60">v0.1.1</p>
        </div>
      </footer>
    </div>
  );
